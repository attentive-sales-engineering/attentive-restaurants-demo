...
, function(e, t, n) {
    ...
    !function(t, n) {
        ...
        var S = function(e) {
            var t, n, i, o, r, s, a, l, c, d, u, p, f, h, m, g, v, y, b, w = "sizzle" + 1 * new Date, x = e.document, T = 0, C = 0, k = le(), S = le(), E = le(), $ = le(), _ = function(e, t) {
                return e === t && (u = !0),
                0
            }, A = {}.hasOwnProperty, O = [], D = O.pop, N = O.push, j = O.push, I = O.slice, P = function(e, t) {
                for (var n = 0, i = e.length; n < i; n++)
                    if (e[n] === t)
                        return n;
                return -1
            }, L = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", H = "(?:\\\\[\\da-fA-F]{1,6}" + M + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", R = "\\[" + M + "*(" + H + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + H + "))|)" + M + "*\\]", q = ":(" + H + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + R + ")*)|.*)\\)|)", F = new RegExp(M + "+","g"), z = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$","g"), B = new RegExp("^" + M + "*," + M + "*"), W = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), V = new RegExp(M + "|>"), U = new RegExp(q), Y = new RegExp("^" + H + "$"), X = {
                ID: new RegExp("^#(" + H + ")"),
                CLASS: new RegExp("^\\.(" + H + ")"),
                TAG: new RegExp("^(" + H + "|[*])"),
                ATTR: new RegExp("^" + R),
            ...
            }, Q = /HTML$/i, G = /^(?:input|select|textarea|button)$/i, K = /^h\d$/i, J = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\[\\da-fA-F]{1,6}" + M + "?|\\\\([^\\r\\n\\f])","g"), ne = function(e, t) {
            ...
            try {
                j.apply(O = I.call(x.childNodes), x.childNodes),
            ...
            ae.matchesSelector = function(e, t) {
                if (p(e),
                n.matchesSelector && m && !$[t + " "] && (!v || !v.test(t)) && (!g || !g.test(t)))
                    try {
                        var i = y.call(e, t);
                    ...
                    CHILD: function(e, t, n, i, o) {
                        ...
                        : function(t, n, l) {
                            ...
                            if (g) {
                                ...
                                s && y) {
                                    for (b = (f = (c = (d = (u = (p = g)[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === T && c[1]) && c[2],
                                ...
                                !1 === b)
                                    for (; (p = ++f && p && p[m] || (b = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && ((d = (u = p[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] = [T, b]),
                                    p !== t)); )
                                        ;
                ...
                ce((function(r, s, a, l) {
                    var c, d, u, p = [], f = [], h = s.length, m = r || function(e, t, n) {
                        for (var i = 0, o = t.length; i < o; i++)
                            ae(e, t[i], n);
                        return n
                    }(t || "*", a.nodeType ? [a] : a, []), g = !e || !r && t ? m : Te(m, p, e, a, l), v = n ? o || (r ? e : h || i) ? [] : s : g;
                    if (n && n(g, v, a, l),
                    i)
                        for (c = Te(v, f),
                        i(c, [], a, l),
                    ...
                    if (n = i.relative[e[l].type])
                        ...
                        if ((n = i.filter[e[l].type].apply(null, e[l].matches))[w]) {
                            ...
                            return Ce(l > 1 && xe(p), l > 1 && be(e.slice(0, l - 1).concat({
                                value: " " === e[l - 2].type ? "*" : ""
                            })).replace(z, "$1"), n, l < o && ke(e.slice(l, o)), o < r && ke(e = e.slice(o)), o < r && be(e))
                        }
                        p.push(n)
                    }
                return xe(p)
                    ...
                    (a = E(e, function(e, t) {
                        var n = t.length > 0
                          ...
                          , r = function(r, s, a, l, d) {
                            var u, h, g, v = 0, y = "0", b = r && [], w = [], x = c, C = r || o && i.find.TAG("*", d), k = T += null == x ? 1 : Math.random() || .1, S = C.length;
                ...
                var t = [["notify", "progress", C.Callbacks("memory"), C.Callbacks("memory"), 2], ["resolve", "done", C.Callbacks("once memory"), C.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", C.Callbacks("once memory"), C.Callbacks("once memory"), 1, "rejected"]]
                  ...
                  , o = {
                    ...
                    then: function(e, i, o) {
                                ...
                                var a = this
                                  ...
                                  , c = function() {
                                    ...
                                    if (!(e < r)) {
                                        ...
                                        v(c) ? o ? c.call(n, s(r, t, H, o), s(r, t, R, o)) : (r++,
                                        c.call(n, s(r, t, H, o), s(r, t, R, o), s(r, t, H, t.notifyWith))) : (i !== H && (a = void 0,
                                        l = [n]),
                                        (o || t.resolveWith)(a, l))
                                    }
                                }
                        ...
                        return C.Deferred((function(n) {
                            t[0][3].add(s(0, n, v(o) ? o : H, n.notifyWith)),
        ...
        C.ready.then = z.then,
        "complete" === b.readyState || "loading" !== b.readyState && !b.documentElement.doScroll ? n.setTimeout(C.ready) : (b.addEventListener("DOMContentLoaded", B),
        ...
        C.fn.extend({
            data: function(e, t) {
                ...
                return "object" == typeof e ? this.each((function() {
                    ...
                    var n;
                    if (r && void 0 === t)
                        return void 0 !== (n = J.get(r, e)) || void 0 !== (n = te(r, e)) ? n : void 0;
                    this.each((function() {
                        J.set(this, e, t)
                    }
                    ))
        ...
        C.extend({
            queue: function(e, t, n) {
                ...
                if (e)
                    return t = (t || "fx") + "queue",
                    i = K.get(e, t),
                    n && (!i || Array.isArray(n) ? i = K.access(e, t, C.makeArray(n)) : i.push(n)),
                    i || []
            },
        ...
        C.event = {
            ...
            dispatch: function(e) {
                var t, n, i, o, r, s, a = new Array(arguments.length), l = C.event.fix(e), c = (K.get(this, "events") || Object.create(null))[l.type] || [], d = C.event.special[l.type] || {};
                for (a[0] = l,
            ...
            special: {
                ...
                click: {
                    setup: function(e) {
                        var t = this || e;
                        return me.test(t.type) && t.click && A(t, "input") && Oe(t, "click", Ee),
                        !1
                    },
                    trigger: function(e) {
                        var t = this || e;
        ...
        function Re(e, t, n, i) {
            ...
            if (p && (r = (o = Te(t, e[0].ownerDocument, !1, e, i)).firstChild,
            1 === o.childNodes.length && (o = r),
            r || i)) {
                for (a = (s = C.map(be(o, "script"), Pe)).length; u < p; u++)
                    c = o,
                    u !== f && (c = C.clone(c, !0, !0),
                    a && C.merge(s, be(c, "script"))),
                    n.call(e[u], c, u);
                if (a)
                    ...
                    u = 0; u < a; u++)
                        c = s[u],
                        ve.test(c.type || "") && !K.access(c, "globalEval") && C.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? C._evalUrl && !c.noModule && C._evalUrl(c.src, {
        ...
        function qe(e, t, n) {
            for (var i, o = t ? C.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
                ...
                i.parentNode && (n && se(i) && we(be(i, "script")),
        ...
        function Ve(e, t, n) {
            ...
            !g.pixelBoxStyles() && Fe.test(s) && We.test(t) && (i = a.width,
            o = a.minWidth,
            r = a.maxWidth,
        ...
        function it(e, t, n) {
            ...
            return (!g.boxSizingReliable() && o || !g.reliableTrDimensions() && A(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === C.css(e, "display", !1, i)) && e.getClientRects().length && (o = "border-box" === C.css(e, "boxSizing", !1, i),
            (r = a in e) && (s = e[a])),
        ...
        C.each(["height", "width"], (function(e, t) {
            C.cssHooks[t] = {
                get: function(e, n, i) {
                    if (n)
                        return !Ke.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? it(e, t, i) : Be(e, Ze, (function() {
                            return it(e, t, i)
                        }
                        ))
                },
                set: function(e, n, i) {
                    var o, r = ze(e), s = !g.scrollboxSize() && "absolute" === r.position, a = (s || i) && "border-box" === C.css(e, "boxSizing", !1, r), l = i ? nt(e, t, i, a, r) : 0;
        ...
        function ct() {
            st && (!1 === b.hidden && n.requestAnimationFrame ? n.requestAnimationFrame(ct) : n.setTimeout(ct, C.fx.interval),
            C.fx.tick())
        }
        function dt() {
        ...
        C.Animation = C.extend(ft, {
            ...
            prefilters: [function(e, t, n) {
                var i, o, r, s, a, l, c, d, u = "width"in t || "height"in t, p = this, f = {}, h = e.style, m = e.nodeType && le(e), g = K.get(e, "fxshow");
        ...
        C.fn.extend({
            ...
            finish: function(e) {
                return !1 !== e && (e = e || "fx"),
                this.each((function() {
                    var t, n = K.get(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = C.timers, s = i ? i.length : 0;
                    for (n.finish = !0,
                    C.queue(this, e, []),
        ...
        C.extend({
            attr: function(e, t, n) {
                ...
                if (3 !== r && 8 !== r && 2 !== r)
                    return void 0 === e.getAttribute ? C.prop(e, t, n) : (1 === r && C.isXMLDoc(e) || (o = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? ht : void 0)),
        ...
        C.extend(C.event, {
            trigger: function(e, t, i, o) {
                var r, s, a, l, c, d, u, p, h = [i || b], m = f.call(e, "type") ? e.type : e, g = f.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = p = a = i = i || b,
                3 !== i.nodeType && 8 !== i.nodeType && !Tt.test(m + C.event.triggered) && (m.indexOf(".") > -1 && (g = m.split("."),
                m = g.shift(),
                g.sort()),
                c = m.indexOf(":") < 0 && "on" + m,
                ...
                o || !u.trigger || !1 !== u.trigger.apply(i, t))) {
                    ...
                    return e.type = m,
                    o || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(h.pop(), t) || !Q(i) || c && v(i[m]) && !y(i) && ((a = i[c]) && (i[c] = null),
                    C.event.triggered = m,
        ...
        C.extend({
            ...
            ajax: function(e, t) {
                ...
                e = void 0),
                t = t || {};
                var i, o, r, s, a, l, c, d, u, p, f = C.ajaxSetup({}, t), h = f.context || f, m = f.context && (h.nodeType || h.jquery) ? C(h) : C.event, g = C.Deferred(), v = C.Callbacks("once memory"), y = f.statusCode || {}, w = {}, x = {}, T = "canceled", k = {
                    readyState: 0,
                ...
                null == f.crossDomain) {
                    ...
                    try {
                        l.href = f.url,
                        l.href = l.href,
                        f.crossDomain = Ft.protocol + "//" + Ft.host != l.protocol + "//" + l.host
                    } catch (e) {
                        f.crossDomain = !0
                    }
                }
                ...
                f.url = o + p),
                f.ifModified && (C.lastModified[o] && k.setRequestHeader("If-Modified-Since", C.lastModified[o]),
                ...
                function S(e, t, s, l) {
                    ...
                    u ? (f.ifModified && ((x = k.getResponseHeader("Last-Modified")) && (C.lastModified[o] = x),
                    ...
                    send: function(o, r) {
                        ...
                        t = function(e) {
                            return function() {
                                ...
                                "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(Vt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                    binary: a.response
                                } : {
                                    text: a.responseText
        ...
        g.createHTMLDocument = ((Yt = b.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
        ...
        C.parseHTML = function(e, t, n) {
            ...
            r = !n && [],
            (o = O.exec(e)) ? [t.createElement(o[1])] : (o = Te([e], t, r),
...
, function(e, t, n) {
    ...
    (function(e) {
        var n = {
            ...
            init: function() {
                var e = this;
                e.$bar.length && ("accepted" !== n.getCookie("cookies") && e.show(e.$bar),
                e.$accept.on("click", (function() {
                    e.hide(e.$bar),
                    e.setCookie("cookies", "accepted", 365)
                }
                )))
            },
            show: function() {
...
, function(e, t, n) {
    ...
    (function(t) {
        ...
        function c(e, t) {
            try {
                return s.setItem(e, JSON.stringify(t)),
                !0
            } catch (e) {
                return !1
            }
    ...
    (function(e) {
        ...
        var c = {
            ...
            setActiveAdditions: function(e, t) {
                var n = this;
                if (e.is(":checked"))
                    n.activeItemAdditionsTotal += t.price,
                    n.activeAdditions.push(t);
                else {
                    ...
                    n.activeItemAdditionsTotal -= t.price,
                    n.activeAdditions.splice(i, 1)
                }
                n.activeItem.additions = n.activeAdditions,
                n.activeItem.totalPrice = n.activeItem.sizes.find((function(e) {
                    return !0 === e.active
                }
            ...
            setActiveSize: function(e, t) {
                ...
                o.active = !0,
                n.activeItem.totalPrice = n.activeItem.totalPrice - i.price + o.price,
                console.log(n.activeItem.sizes, i),
                n.Modal.updatePrice()
            },
            ...
            Panel: {
                ...
                init: function() {
                    ...
                    e.DOM.$panelToggler.on("click", (function() {
                        return e.DOM.$panel.hasClass("show") ? e.hidePanel() : e.showPanel(),
                        !1
                    }
                    )),
                ...
                update: function() {
                    ...
                    0 === o ? (t.DOM.$headerNotification.hide(),
                    t.DOM.$empty.show(),
                    t.DOM.$summary.hide(),
                    t.DOM.$table.hide()) : (t.DOM.$headerNotification.show(),
                    t.DOM.$headerNotification.text(o),
                    t.DOM.$empty.hide(),
                    t.DOM.$summary.show(),
                    t.DOM.$table.show()),
                ...
                showPanel: function() {
                    this.DOM.$panel.addClass("show"),
                    i.b.fadeIn(400)
                },
                hidePanel: function() {
                    this.DOM.$panel.removeClass("show"),
                    i.b.fadeOut(400)
                },
            ...
            Modal: {
                ...
                init: function() {
                    ...
                    i.a.on("click", '[data-action="open-cart-modal"]', (function() {
                        e(this).data("edit") ? t.mode = "EDIT" : t.mode = "ADD",
                        t.showProductModal(e(this).data("id"))
                    }
                    )),
                    t.DOM.$addToCart.on("click", (function() {
                        c.addActiveItemToCart(),
                        t.hideProductModal()
                    }
                    )),
                    t.DOM.$updateCart.on("click", (function() {
                        c.updateActiveItemInCart(),
                        t.hideProductModal()
                    }
                    )),
                    t.DOM.$modal.on("show.bs.modal", (function() {
                        "EDIT" === t.mode ? (t.DOM.$addToCart.hide(),
                        t.DOM.$updateCart.show()) : (t.DOM.$addToCart.show(),
                        t.DOM.$updateCart.hide()),
                        t.build()
                    }
                    )),
                ...
                build: function() {
                    ...
                    try {
                        ...
                        c.activeItem.sizes && c.activeItem.sizes.length > 1 ? (t.DOM.$sizesList.html(""),
                        ...
                        t.DOM.$sizes.show(),
                        t.DOM.$sizes.find(".collapse").addClass("show")) : t.DOM.$sizes.hide(),
                        c.activeCategory.additions && c.activeCategory.additions.length > 1 ? (t.DOM.$additionsList.html(""),
                        ...
                        (!c.activeItem.sizes || c.activeItem.sizes.length <= 1) && t.DOM.$additions.find(".collapse").addClass("show")) : t.DOM.$additions.hide(),
                        o.a.init(t.$modal)
                    } catch (e) {
                ...
                reset: function() {
                    this.DOM.$details.each((function() {
                        ...
                        t.find(".collapse").removeClass("show"),
                        n.find("input").prop("checked", !1),
                        t.hasClass("panel-details-form") || i.html("")
                    }
                    ))
                }
            }
          ...
          , o = {
            ...
            init: function() {
                ...
                t.DOM.$scrollers.find("a").on("click", (function() {
                    ...
                    i.pathname !== o.pathname && "null" !== o.origin || !r || "" === r || (t.scrollTo(r),
                    n.blur()),
                    !1
                }
                )),
                t.DOM.$nav.find("li.has-dropdown > a").on("click", (function() {
                    ...
                    return t.hasClass("dropdown-show") ? (t.removeClass("dropdown-show"),
                    i.a.removeClass("dropdown-visible")) : (t.siblings(".dropdown-show").removeClass("dropdown-show"),
                    t.addClass("dropdown-show"),
                    i.a.addClass("dropdown-visible")),
                    !1
                }
                )),
                ...
                t.DOM.$mobileNav.find("li.has-dropdown > a").on("click", (function() {
                    return e(this).next(".dropdown-container, ul").slideToggle(300),
                    !1
                }
                )),
                t.DOM.$mobileToggler.on("click", (function() {
                    return t.DOM.$mobilePanel.hasClass("show") ? (t.DOM.$mobilePanel.removeClass("show"),
                    i.b.fadeOut(400)) : (t.DOM.$mobilePanel.addClass("show"),
                    i.b.fadeIn(400)),
                    !1
                }
                ))
            ...
            scrollTo: function(t) {
                ...
                }, 600) : console.error("[NAVIGATION] Wrong href - the ID does not exist in the DOM")
            },
            handleClick: function(e) {
                "body" != e.target.localName && "html" != e.target.localName && "body-wrapper" != e.target.id || (this.DOM.$nav.find("li.dropdown-show").removeClass("dropdown-show"),
                i.a.removeClass("dropdown-visible"))
            },
            hideDropdown: function() {
                e(".dropdown-show").removeClass("dropdown-show"),
                i.a.removeClass("dropdown-visible")
            }
        };
        t.a = o
    ...
    (function(e) {
        var i = n(2)
          , o = {
            ...
            init: function() {
                var t = this;
                t.$el.length && (t.offset = t.$el.offset().top,
                t.handleScroll(e(window).scrollTop()))
            },
            handleScroll: function(t) {
                var n = this;
                if (n.$el.length) {
                    ...
                    t > n.offset - o ? n.$el.css({
                        position: "fixed",
                        top: o + "px",
                        width: n.$el.innerWidth() + "px"
                    }) : n.$el.removeAttr("style"),
                    t > i.c.offset().top - n.$el.outerHeight() && n.$el.css({
                        position: "absolute",
...
, function(e, t, n) {
    ...
    (function(e) {
        ...
        var i = {
                ...
                init: function() {
                    ...
                    t.DOM.$contents.length) {
                        ...
                        n.children(".next").on("click", (function() {
                            return t.DOM.$contents.slick("slickNext"),
                            e(this).blur(),
                            !1
                        }
                        )),
                        n.children(".prev").on("click", (function() {
                            return t.DOM.$contents.slick("slickPrev"),
                            e(this).blur(),
                            !1
                        }
                        ))
            ...
            Gallery: {
                DOM: {
                    $images: e(".gallery-carousel", "#content"),
                    $nav: e(".gallery-nav", "#content")
                },
                init: function() {
                    var e = this;
                ...
                init: function() {
                    this.$el.length > 0 && this.$el.submit((function() {
                        var t = e(this).find(".btn-submit")
                          , n = e(this);
                        return !!n.valid() && (t.addClass("loading"),
                        e.ajax({
                            type: "POST",
...
, function(e, t, n) {
    ...
    (function(e) {
        ...
        var i = n(4)
          , o = {
            DOM: {
                $timeout: e(".modal[data-timeout]"),
                $video: e('[data-toggle="video-modal"]')
            },
            init: function() {
                this.DOM.$timeout.each((function() {
                    ...
                    o ? ("complete" !== i.a.getCookie(o) && t.modal("show"),
                ...
                this.DOM.$video.on("click", (function() {
                    var t = e(this).data("target")
                      , n = e(this).data("video");
                    return e(t + " iframe").attr("src", n + "?autoplay=1"),
                    e(t).modal("show"),
                    e(t).on("hidden.bs.modal", (function() {
                        var n = e(t + " .modal-content");
                        e(t + " iframe").remove(),
                        n.html('<iframe height="500"></iframe>')
                    }
                    )),
                    !1
                }
...
, function(e, t, n) {
    ...
    var i = n(25)
      , o = {
        init: function() {
            Object(i.jarallax)(document.querySelectorAll(".bg-image.bg-parallax"), {
                speed: .75
            })
        }
    };
...
, function(e, t, n) {
    ...
    void 0 === (r = "function" == typeof (i = function() {
        ...
        function b(e) {
            for (var t = e.getElementsByTagName("a"), n = t.length - 1; n >= 0; n--)
                t[n].setAttribute("target", "_blank"),
                t[n].setAttribute("rel", "noopener")
        }
        function w(e, t) {
        ...
        function x(e) {
            if (void 0 !== e && e.innerHTML.indexOf("data-image") >= 0) {
                for (var t = e.innerHTML.match(/data-image=\"([^"]+)\"/gi), n = 0; n < t.length; n++)
                    t[n] = t[n].match(/data-image=\"([^"]+)\"/i)[1],
                    t[n] = decodeURIComponent(t[n]) + ".jpg";
                return t
            }
        }
        var T = {
            fetch: function(l) {
                ...
                o)
                    ...
                    void 0 !== l.list ? v.src = "https://syndication.twitter.com/timeline/list?callback=__twttrf.callback&dnt=false&list_slug=" + l.list.listSlug + "&screen_name=" + l.list.screenName + "&suppress_response_codes=true&lang=" + (l.lang || "en") + "&rnd=" + Math.random() : void 0 !== l.profile ? v.src = "https://syndication.twitter.com/timeline/profile?callback=__twttrf.callback&dnt=false&screen_name=" + l.profile.screenName + "&suppress_response_codes=true&lang=" + (l.lang || "en") + "&rnd=" + Math.random() : void 0 !== l.likes ? v.src = "https://syndication.twitter.com/timeline/likes?callback=__twttrf.callback&dnt=false&screen_name=" + l.likes.screenName + "&suppress_response_codes=true&lang=" + (l.lang || "en") + "&rnd=" + Math.random() : void 0 !== l.collection ? v.src = "https://syndication.twitter.com/timeline/collection?callback=__twttrf.callback&dnt=false&collection_id=" + l.collection.collectionId + "&suppress_response_codes=true&lang=" + (l.lang || "en") + "&rnd=" + Math.random() : v.src = "https://cdn.syndication.twimg.com/widgets/timelines/" + l.id + "?&lang=" + (l.lang || "en") + "&callback=__twttrf.callback&suppress_response_codes=true&rnd=" + Math.random(),
                    y.appendChild(v)
                }
            },
            callback: function(v) {
                if (void 0 === v || void 0 === v.body)
                    return o = !1,
                    void (i.length > 0 && (T.fetch(i[0]),
                    i.splice(0, 1)));
                ...
                function k(e) {
                    ...
                    if (t)
                        ...
                        i.setAttribute("src", "https://twitter.com/" + n + "/profile_image?size=bigger"),
                        e.prepend(i)
                    }
                    return e
                }
                C.innerHTML = v.body,
                void 0 === C.getElementsByClassName && (l = !1);
                var S = []
                  , E = []
                  , $ = []
                  , _ = []
                ...
                if (l)
                    for (var j = C.getElementsByClassName("timeline-Tweet"); N < j.length; )
                        ...
                        (!A[N] || A[N] && c) && (S.push(j[N].getElementsByClassName("timeline-Tweet-text")[0]),
                    ...
                    for (j = w(C, "timeline-Tweet"); N < j.length; )
                        ...
                        (!A[N] || A[N] && c) && (S.push(w(j[N], "timeline-Tweet-text")[0]),
                        O.push(j[N].getAttribute("data-tweet-id")),
                        ...
                        N++;
                S.length > t && (S.splice(t, S.length - t),
                E.splice(t, E.length - t),
                $.splice(t, $.length - t),
                A.splice(t, A.length - t),
                _.splice(t, _.length - t),
                D.splice(t, D.length - t));
                var I = []
                  , P = (N = S.length,
                0);
                if (g)
                    for (; P < N; )
                        I.push({
                            tweet: S[P].innerHTML,
                            tweetText: S[P].textContent,
                            author: E[P] ? E[P].innerHTML : "Unknown Author",
                            author_data: {
                                profile_url: E[P] ? E[P].querySelector('[data-scribe="element:user_link"]').href : null,
                                profile_image: E[P] ? "https://twitter.com/" + E[P].querySelector('[data-scribe="element:screen_name"]').title.split("@")[1] + "/profile_image?size=bigger" : null,
                                profile_image_2x: E[P] ? "https://twitter.com/" + E[P].querySelector('[data-scribe="element:screen_name"]').title.split("@")[1] + "/profile_image?size=original" : null,
                                screen_name: E[P] ? E[P].querySelector('[data-scribe="element:screen_name"]').title : null,
                                name: E[P] ? E[P].querySelector('[data-scribe="element:name"]').title : null
                            },
                            time: $[P].textContent,
                            timestamp: $[P].getAttribute("datetime").replace("+0000", "Z").replace(/([\+\-])(\d\d)(\d\d)/, "$1$2:$3"),
                            image: x(_[P]) ? x(_[P])[0] : void 0,
                            images: x(_[P]),
                            rt: A[P],
                            tid: O[P],
                            permalinkURL: void 0 === D[P] ? "" : D[P].href
                        }),
                        P++;
                else
                    for (; P < N; ) {
                        if ("string" != typeof a) {
                            var L = $[P].getAttribute("datetime")
                              , M = new Date($[P].getAttribute("datetime").replace(/-/g, "/").replace("T", " ").split("+")[0])
                              , H = a(M, L);
                            if ($[P].setAttribute("aria-label", H),
                            S[P].textContent)
                                if (l)
                                    $[P].textContent = H;
                                else {
                        ...
                        if (n ? (h && (b(S[P]),
                        s && b(E[P])),
                        s && (F += '<div class="user">' + y(E[P].innerHTML) + "</div>"),
                        F += '<p class="tweet">' + y(S[P].innerHTML) + "</p>",
                        r && (F += m ? '<p class="timePosted"><a href="' + D[P] + '">' + $[P].getAttribute("aria-label") + "</a></p>" : '<p class="timePosted">' + $[P].getAttribute("aria-label") + "</p>")) : (S[P].textContent,
                        s && (F += '<p class="user">' + E[P].textContent + "</p>"),
                        F += '<p class="tweet">' + S[P].textContent + "</p>",
                        r && (F += '<p class="timePosted">' + $[P].textContent + "</p>")),
                        u && (F += '<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to=' + O[P] + '" class="twitter_reply_icon"' + (h ? ' target="_blank" rel="noopener">' : ">") + 'Reply</a><a href="https://twitter.com/intent/retweet?tweet_id=' + O[P] + '" class="twitter_retweet_icon"' + (h ? ' target="_blank" rel="noopener">' : ">") + 'Retweet</a><a href="https://twitter.com/intent/favorite?tweet_id=' + O[P] + '" class="twitter_fav_icon"' + (h ? ' target="_blank" rel="noopener">' : ">") + "Favorite</a></p>"),
                        p && void 0 !== _[P] && void 0 !== x(_[P]))
                            for (var z = x(_[P]), B = 0; B < z.length; B++)
                                F += '<div class="media"><img src="' + z[B] + '" alt="Image from tweet" /></div>';
                        (p || !p && S[P].textContent.length) && I.push(F),
                        P++
                    }
                !function(t) {
                    if (null === d) {
                ...
                o = !1,
                i.length > 0 && (T.fetch(i[0]),
                i.splice(0, 1))
            }
        };
        return window.__twttrf = T,
              ...
              , n = {
                ...
                in: function() {
                    var i = e(this)
                      ...
                      , d = i.data(t).outClass;
                    o.loading && n.removeLoading.call(this),
                    d && i.removeClass(d),
                    c ? n.inOverlay.call(this, l, a) : n.inDefault.call(this, l, a)
                },
                ...
                out: function(i, o) {
                    ...
                    r.data(t).outClass = f,
                    m ? n.outOverlay.call(this, f, h, o) : n.outDefault.call(this, f, h, o)
                },
        ...
        e.fn.appear = function(t, n) {
            ...
            return this.each((function() {
                ...
                t) {
                    ...
                    i.one ? n.one("appear", i.data, s) : n.bind("appear", i.data, s),
                    o.scroll(r),
    ...
    (function(t) {
        ...
        e.exports = {
            on: function(e, n) {
                ...
                t.addEventListener ? t.addEventListener("storage", r, !1) : t.attachEvent ? t.attachEvent("onstorage", r) : t.onstorage = r
            },
            off: function(e, t) {
                var n = o[e];
    ...
    e.exports = function(e, t) {
        ...
        var s = "collapse"
          ...
          , u = function() {
            ...
            p.show = function() {
                ...
                n && (o = e(n).not(this._selector).data(a)) && o._isTransitioning))) {
                    ...
                    !s.isDefaultPrevented()) {
                        n && (i._jQueryInterface.call(e(n).not(this._selector), "hide"),
                        o || e(n).data(a, null));
            ...
            ,
            p._getConfig = function(e) {
                return (e = r(r({}, c), e)).toggle = Boolean(e.toggle),
                t.typeCheckConfig(s, e, d),
                e
            }
            ,
            ...
            i._jQueryInterface = function(t) {
                return this.each((function() {
                    ...
                    if (!o && s.toggle && "string" == typeof t && /show|hide/.test(t) && (s.toggle = !1),
                    o || (o = new i(this,s),
                    n.data(a, o)),
                    "string" == typeof t) {
                        if (void 0 === o[t])
...
, function(e, t, n) {
    e.exports = function(e, t, n) {
            ...
            for (var i = (new window.DOMParser).parseFromString(e, "text/html"), o = Object.keys(t), r = [].slice.call(i.body.querySelectorAll("*")), s = function(e, n) {
                ...
                l.forEach((function(e) {
                    (function(e, t) {
                        ...
                        if (-1 !== t.indexOf(n))
                            return -1 === a.indexOf(n) || Boolean(e.nodeValue.match(c) || e.nodeValue.match(d));
          ...
          , x = function() {
            ...
            c._getOffset = function() {
                ...
                return "function" == typeof this.config.offset ? t.fn = function(t) {
                    return t.offsets = s(s({}, t.offsets), e.config.offset(t.offsets, e.element) || {}),
                    t
                }
        ...
        return e.fn[p] = x._jQueryInterface,
    ...
    function(e) {
        ...
        function R(e, t, n) {
            return (void 0 === n ? e : e.slice(0, function(e, t, n) {
                ...
                e.enabled && r(n) && (t.offsets.popper = S(t.offsets.popper),
            ...
            modifiers: {
                ...
                arrow: {
                    ...
                    fn: function(e, t) {
                        ...
                        return w = Math.max(Math.min(a[d] - m, w), 0),
                        e.arrowElement = i,
                        e.offsets.arrow = (C(n = {}, p, Math.round(w)),
                        C(n, f, ""),
                        n),
                        e
                    },
          ...
          , o = function() {
            ...
            return a.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass("active") || e(this._element).hasClass("disabled"))) {
                    var i, o, r = e(this._element).closest(".nav, .list-group")[0], s = t.getSelectorFromElement(this._element);
                    if (r) {
        ...
        var s = "scrollspy"
          ...
          , d = function() {
            ...
            u._getConfig = function(n) {
                ...
                return t.typeCheckConfig(s, n, c),
                n
            }
            ,
            ...
            i._jQueryInterface = function(t) {
                return this.each((function() {
                    ...
                    if (n || (n = new i(this,"object" == typeof t && t),
...
, function(e, t, n) {
    ...
    void 0 === (r = "function" == typeof (i = function(e) {
        ...
        e.extend(e.fn, {
            ...
            rules: function(t, n) {
                var i, o, r, s, a, l, c = this[0], d = void 0 !== this.attr("contenteditable") && "false" !== this.attr("contenteditable");
        ...
        e.extend(e.validator, {
            ...
            prototype: {
                ...
                element: function(t) {
                    ...
                    (i = this.groups[r.name]) && e.each(this.groups, (function(e, t) {
                        t === i && e !== r.name && (o = s.validationTargetFor(s.clean(s.findByName(e)))) && o.name in s.invalid && (s.currentElements.push(o),
                        a = s.check(o) && a)
                    }
                    )),
                    n = !1 !== this.check(r),
                ...
                elementValue: function(t) {
                    var n, i, o = e(t), r = t.type, s = void 0 !== o.attr("contenteditable") && "false" !== o.attr("contenteditable");
                    return "radio" === r || "checkbox" === r ? this.findByName(t.name).filter(":checked").val() : "number" === r && void 0 !== t.validity ? t.validity.badInput ? "NaN" : o.val() : (n = s ? o.text() : o.val(),
            ...
            methods: {
                ...
                step: function(t, n, i) {
                    var o, r = e(n).attr("type"), s = "Step attribute on input type " + r + " is not supported.", a = new RegExp("\\b" + r + "\\b"), l = function(e) {
                        var t = ("" + e).match(/(?:\.(\d+))?$/);
...
, function(e, t, n) {
    ...
    var i = function() {
        ...
        e.prototype.createUrl = function() {
            ...
            for (var n in this.apiKey && t.push("key=" + this.apiKey),
            this.options)
                if (this.options.hasOwnProperty(n)) {
                    var i = this.options[n];
                    "version" === n && (n = "v"),
                    "libraries" === n && (i = i.join(",")),
                    t.push(n + "=" + i)
                }
...
, function(e, t, n) {
    ...
    let d, u;
    function p() {
        l ? (!d && document.body && (d = document.createElement("div"),
        d.style.cssText = "position: fixed; top: -9999px; left: 0; height: 100vh; width: 0;",
        document.body.appendChild(d)),
        u = (d ? d.clientHeight : 0) || r.window.innerHeight || document.documentElement.clientHeight) : u = r.window.innerHeight || document.documentElement.clientHeight
    }
    p(),
    ...
    class g {
        constructor(e, t) {
            ...
            if ("function" != typeof n.options.disableParallax && (n.options.disableParallax = ()=>!1),
        ...
        css(e, t) {
            return "string" == typeof t ? r.window.getComputedStyle(e).getPropertyValue(t) : (t.transform && c && (t[c] = t.transform),
        ...
        addToParallaxList() {
            ...
            1 === f.length && r.window.requestAnimationFrame(h)
        }
        ...
        coverImage() {
            ...
            let r = 0
              , s = n
              , a = 0;
            return o && (0 > i ? (r = i * Math.max(n, u),
            u < n && (r -= i * (n - u))) : r = i * (n + u),
            1 < i ? s = Math.abs(r - u) : 0 > i ? s = r / i + Math.abs(r) : s += (u - n) * (1 - i),
            r /= 2),
        ...
        onScroll(e) {
            ...
            const l = Math.max(0, i)
              ...
              , m = 1 - (u - i) / (u + o) * 2;
            let g = 1;
            if (o < u ? g = 1 - (d || p) / o : c <= u ? g = c / u : f <= u && (g = f / u),
            ...
            "scale" === t.options.type || "scale-opacity" === t.options.type) {
                let e = 1;
                0 > t.options.speed ? e -= t.options.speed * g : e += t.options.speed * (1 - g),
                s.transform = `scale(${e}) translate3d(0,0,0)`
            }
            if ("scroll" === t.options.type || "scroll-opacity" === t.options.type) {
                let e = t.parallaxScrollDistance * m;
                "absolute" === t.image.position && (e -= i),
    ...
    const v = function(e, t, ...n) {
        ...
        let o, r = 0;
        for (; r < i; r += 1)
            if ("object" == typeof t || void 0 === t ? e[r].jarallax || (e[r].jarallax = new g(e[r],t)) : e[r].jarallax && (o = e[r].jarallax[t].apply(e[r].jarallax, n)),
            void 0 !== o)
                return o;
        return e
    };
    ...
    function r(e=o.a.jarallax) {
        ...
        ["initImg", "canInitParallax", "init", "destroy", "clipContainer", "coverImage", "isVisible", "onScroll", "onResize"].forEach(e=>{
            ...
            t.prototype[e] = function(...t) {
                const i = this;
                if ("initImg" === e && null !== i.$item.getAttribute("data-jarallax-element") && (i.options.type = "element",
                i.pureOptions.speed = i.$item.getAttribute("data-jarallax-element") || i.pureOptions.speed),
                "element" !== i.options.type)
                    return n.apply(i, t);
                switch (i.pureOptions.threshold = i.$item.getAttribute("data-threshold") || "",
                e) {
                case "init":
                    const e = i.pureOptions.speed.split(" ");
                    i.options.speed = i.pureOptions.speed || 0,
                    i.options.speedY = e[0] ? parseFloat(e[0]) : 0,
                    i.options.speedX = e[1] ? parseFloat(e[1]) : 0;
                    const o = i.pureOptions.threshold.split(" ");
                    i.options.thresholdY = o[0] ? parseFloat(o[0]) : null,
                    i.options.thresholdX = o[1] ? parseFloat(o[1]) : null,
                    n.apply(i, t);
                    const r = i.$item.getAttribute("data-jarallax-original-styles");
                    return r && i.$item.setAttribute("style", r),
                    !0;
                case "onResize":
                ...
                case "onScroll":
                    ...
                    let p = d
                      , f = u;
                    null !== i.options.thresholdY && d > i.options.thresholdY && (p = 0),
                    null !== i.options.thresholdX && u > i.options.thresholdX && (f = 0),
                    i.css(i.$item, {
...
, function(e, t) {
    !function() {
        ...
        o.replace(/[?&]([^&=]+)=([^&]+)/g, (function(e, t, n) {
            ...
            "autorun" == (t = decodeURIComponent(t)) ? c = !/^[0fn]/i.test(n) : "lang" == t ? d.push(n) : "skin" == t ? u.push(n) : "callback" == t && p.push(n)
        }
        ));
        for (var f = "https://cdn.rawgit.com/google/code-prettify/master/loader", h = (s = 0,
        d.length); s < h; ++s)
            !function(e) {
                var n = t.createElement("script");
                n.onload = n.onerror = n.onreadystatechange = function() {
                    !n || n.readyState && !/loaded|complete/.test(n.readyState) || (n.onerror = n.onload = n.onreadystatechange = null,
                    --m,
                    g(),
        ...
        for (s = 0,
        h = u.length; s < h; ++s)
            v.push(f + "/skins/" + encodeURIComponent(u[s]) + ".css");
        ...
        function(e) {
            ...
            !function o(r) {
                if (r !== n) {
                    ...
                    s.rel = "stylesheet",
                    s.type = "text/css",
                    r + 1 < n && (s.error = s.onerror = function() {
                        o(r + 1)
                    }
                    ),
                    s.href = e[r],
        ...
        var y = function() {
            var e;
            return window.PR_SHOULD_USE_CONTINUATION = !0,
            function() {
                var t = window
                            ...
                            function c(e) {
                                ...
                                for (var r = i ? 1 : 0, s = t.length; r < s; ++r) {
                                    ...
                                    if (/\\[bdsw]/i.test(c))
                                        ...
                                        var d, u = a(c);
                                        r + 2 < s && "-" === t[r + 1] ? (d = a(t[r + 2]),
                                        r += 2) : d = u,
                                        n.push([u, d]),
                                        d < 65 || u > 122 || (d < 65 || u > 90 || n.push([32 | Math.max(65, u), 32 | Math.min(d, 90)]),
                                        d < 97 || u > 122 || n.push([-33 & Math.max(97, u), -33 & Math.min(d, 122)]))
                                    }
                                }
                                n.sort((function(e, t) {
                      ...
                      , r = function(e) {
                        for (var s = e.sourceCode, a = e.basePos, l = e.sourceNode, c = [a, "pln"], d = 0, u = s.match(n) || [], p = {}, h = 0, m = u.length; h < m; ++h) {
                            ...
                            if ("string" == typeof y)
                                ...
                                !(g = y.length >= 5 && "lang-" === y.substring(0, 5)) || b && "string" == typeof b[1] || (g = !1,
                                y = "src"),
                                g || (p[v] = y)
                            }
                            var C = d;
                            ...
                            g) {
                                ...
                                var $ = y.substring(5);
                                f(l, a + C, v.substring(0, S), r, c),
                                f(l, a + C + S, k, T($, k), c),
                                f(l, a + C + E, v.substring(E), r, c)
                            } else
                                c.push(a + C, y)
                        }
                        e.decorations = c
                ...
                function v(e) {
                    ...
                    n.push(["str", /^<(?:(?:(?:\.\.\/)*|\/?)(?:[\w-]+(?:\/[\w-]+)+)?[\w-]+\.h(?:h|pp|\+\+)?|[a-z]\w*)>/, null])) : t.push(["com", /^#[^\r\n]*/, null, "#"])),
                    ...
                    c.length && n.push(["kwd", new RegExp("^(?:" + c.replace(/[\s,]+/g, "|") + ")\\b"), null]),
                    t.push(["pln", /^\s+/, null, " \r\n\t "]);
                    var d = "^.[^\\s\\w.$@'\"`/\\\\]*";
                    return e.regexLiterals && (d += "(?!s*/)"),
                    n.push(["lit", /^@[a-z_$][a-z_$@0-9]*/i, null], ["typ", /^(?:[@_]?[A-Z]+[a-z][A-Za-z_$@0-9]*|\w+_t\b)/, null], ["pln", /^[a-z_$][a-z_$@0-9]*/i, null], ["lit", new RegExp("^(?:0x[a-f0-9]+|(?:\\d(?:_\\d+)*\\d*(?:\\.\\d*)?|\\.\\d\\+)(?:e[+\\-]?\\d+)?)[a-z]*","i"), null, "0123456789"], ["pln", /^\\[\s\S]?/, null], ["pun", new RegExp(d), null]),
                    g(t, n)
                }
                var y = v({
                ...
                function b(e, t, n) {
                    for (var i = /(?:^|\s)nocode(?:\s|$)/, o = /\r\n?|\n/, r = e.ownerDocument, s = r.createElement("li"); e.firstChild; )
                        ...
                        if (1 != t || i.test(e.className)) {
                            if ((3 == t || 4 == t) && n) {
                                ...
                                if (a) {
                                    ...
                                    if (u)
                                        e.parentNode.insertBefore(r.createTextNode(u), e.nextSibling);
                                    c(e),
                                    d || e.parentNode.removeChild(e)
                                }
                            }
                    ...
                    function c(e) {
                        ...
                        for (var t, n = function e(t, n) {
                            ...
                            return i
                        }(e.nextSibling, 0); (t = n.parentNode) && 1 === t.nodeType; )
                            n = t;
                        a.push(n)
                    }
                    ...
                    for (var p = Math.max(0, t - 1 | 0) || 0, f = (d = 0,
                    a.length); d < f; ++d)
                        (s = a[d]).className = "L" + (d + p) % 10,
                        s.firstChild || s.appendChild(r.createTextNode(" ")),
                        u.appendChild(s);
                    e.appendChild(u)
                }
                var w = {};
                ...
                function C(e) {
                    ...
                    try {
                        ...
                        function(e) {
                            ...
                            t = t && +t[1] <= 8;
                            var n, i, o = /\n/g, r = e.sourceCode, s = r.length, a = 0, l = e.spans, c = l.length, d = 0, u = e.decorations, p = u.length, f = 0;
                            for (u[p] = s,
                            i = n = 0; i < p; )
                                u[i] !== u[i + 2] ? (u[n++] = u[i++],
                                u[n++] = u[i++]) : i += 2;
                            for (p = n,
                            i = n = 0; i < p; ) {
                                for (var h = u[i], m = u[i + 1], g = i + 2; g + 2 <= p && u[g + 1] === m; )
                                    g += 2;
                                u[n++] = h,
                                u[n++] = m,
                                i = g
                            ...
                            try {
                                for (; d < c; ) {
                                    l[d];
                                    var b, w = l[d + 2] || s, x = u[f + 2] || s, T = (g = Math.min(w, x),
                                    l[d + 1]);
                                    if (1 !== T.nodeType && (b = r.substring(a, g))) {
                                        ...
                                        S.replaceChild(k, T),
                                        k.appendChild(T),
                                        a < w && (l[d + 1] = T = C.createTextNode(r.substring(g, w)),
                                        S.insertBefore(T, k.nextSibling))
                                    }
                                    (a = g) >= w && (d += 2),
                                    a >= x && (f += 2)
                                }
                ...
                function S(e, n) {
                    ...
                    for (var s = [r("pre"), r("code"), r("xmp")], a = [], l = 0; l < s.length; ++l)
                        for (var c = 0, d = s[l].length; c < d; ++c)
                            a.push(s[l][c]);
                    s = null;
                    var u = Date;
                    u.now || (u = {
                    ...
                    !function n() {
                        for (var i = t.PR_SHOULD_USE_CONTINUATION ? u.now() + 250 : 1 / 0; p < a.length && u.now() < i; p++) {
                            for (var r = a[p], s = x, l = r; l = l.previousSibling; ) {
                                ...
                                if (d ? !/^\??prettify\b/.test(d) : 3 !== c || /\S/.test(l.nodeValue))
                                    break;
                                if (d) {
                                    s = {},
                            ...
                            if ((s !== x || h.test(T)) && !g.test(T)) {
                                ...
                                if (!k) {
                                    ...
                                    var $, _, A = s.lang;
                                    if (!A)
                                        !(A = T.match(f)) && ($ = m(r)) && y.test($.tagName) && (A = $.className.match(f)),
                                        A && (A = A[1]);
                                    if (v.test(r.tagName))
                                        _ = 1;
                                    else {
                ...
                x(y, ["default-code"]),
                x(g([], [["pln", /^[^<?]+/], ["dec", /^<!\w[^>]*(?:>|$)/], ["com", /^<\!--[\s\S]*?(?:-\->|$)/], ["lang-", /^<\?([\s\S]+?)(?:\?>|$)/], ["lang-", /^<%([\s\S]+?)(?:%>|$)/], ["pun", /^(?:<[%?]|[%?]>)/], ["lang-", /^<xmp\b[^>]*>([\s\S]+?)<\/xmp\b[^>]*>/i], ["lang-js", /^<script\b[^>]*>([\s\S]*?)(<\/script\b[^>]*>)/i], ["lang-css", /^<style\b[^>]*>([\s\S]*?)(<\/style\b[^>]*>)/i], ["lang-in.tag", /^(<\/?[a-z][^<>]*>)/i]]), ["default-markup", "htm", "html", "mxml", "xhtml", "xml", "xsl"]),
        ...
        function b() {
            c && function(i) {
                var o = t.addEventListener
                  ...
                  , c = o ? "" : "on"
                  , d = function(n) {
                    "readystatechange" == n.type && "complete" != t.readyState || (("load" == n.type ? e : t)[l](c + n.type, d, !1),
                    !r && (r = !0) && i.call(e, n.type || n))
                }
                  , u = function() {
                    try {
                        n.doScroll("left")
                ...
                if ("complete" == t.readyState)
                    ...
                    t[a](c + "DOMContentLoaded", d, !1),
                    t[a](c + "readystatechange", d, !1),
                    e[a](c + "load", d, !1)
                }
            }((function() {
                var t = p.length;
...
, function(e, t, n) {
    ...
    class f {
        ...
        play(e) {
            ...
            o.a.YT.PlayerState.PLAYING !== t.player.getPlayerState() && t.player.playVideo()),
        ...
        pause() {
            const e = this;
            e.player && ("youtube" === e.type && e.player.pauseVideo && o.a.YT.PlayerState.PLAYING === e.player.getPlayerState() && e.player.pauseVideo(),
        ...
        getVolume(e) {
            ...
            "vimeo" === t.type && t.player.getVolume && t.player.getVolume().then(t=>{
                e(t)
            }
            ),
        ...
        getImageURL(e) {
            ...
            if (t.videoImage)
                ...
                if ("youtube" === t.type) {
                    ...
                    const o = new Image;
                    o.onload = function() {
                        120 !== (this.naturalWidth || this.width) || i === n.length - 1 ? (t.videoImage = `https://img.youtube.com/vi/${t.videoID}/${n[i]}.jpg`,
                        e(t.videoImage)) : (i += 1,
                        this.src = `https://img.youtube.com/vi/${t.videoID}/${n[i]}.jpg`)
                    }
                    ,
                ...
                if ("vimeo" === t.type) {
                    ...
                    n.onreadystatechange = function() {
                        if (4 === this.readyState && 200 <= this.status && 400 > this.status) {
                            ...
                            t.videoImage = n[0].thumbnail_large,
                            e(t.videoImage)
                        }
                    }
                    ,
        ...
        getVideo(e) {
            ...
            t.$video ? e(t.$video) : t.onAPIready(()=>{
                let n;
                if (t.$video || (n = document.createElement("div"),
                ...
                "youtube" === t.type) {
                    ...
                    t.playerOptions.events = {
                        onReady(e) {
                            if (t.options.mute ? e.target.mute() : t.options.volume && e.target.setVolume(t.options.volume),
                            ...
                            setInterval(()=>{
                                t.getVolume(n=>{
                                    t.options.volume !== n && (t.options.volume = n,
                        ...
                        onStateChange(n) {
                            ...
                            e || n.data !== o.a.YT.PlayerState.PLAYING || (e = 1,
                            t.fire("started", n)),
                            ...
                            n.data === o.a.YT.PlayerState.PLAYING ? i = setInterval(()=>{
                                t.fire("timeupdate", n),
                    ...
                    r && (t.$video = document.getElementById(t.playerID),
                ...
                if ("vimeo" === t.type) {
                    ...
                    t.options.showContols || (t.playerOptions.badge = 0,
                    ...
                    !t.$video) {
                        ...
                        Object.keys(t.playerOptions).forEach(n=>{
                            "" !== e && (e += "&"),
                            e += `${n}=${encodeURIComponent(t.playerOptions[n])}`
                        }
                        ),
                    ...
                    t.player.on("timeupdate", n=>{
                        ...
                        e = 1),
                        t.fire("timeupdate", n),
                        t.options.endTime && t.options.endTime && n.seconds >= t.options.endTime && (t.options.loop ? t.play(t.options.startTime) : t.pause())
                    }
                    ),
                    t.player.on("play", e=>{
                        t.fire("play", e),
        ...
        onAPIready(e) {
            ...
            "vimeo" === this.type)
                if (void 0 !== o.a.Vimeo || d)
                    ...
                    d = 1;
                    const t = setInterval(()=>{
                        void 0 !== o.a.Vimeo && (clearInterval(t),
                        p.resolve("done"),
                        e())
                    }
                    , 20)
        ...
        t.prototype.coverImage = function() {
            ...
            if (t && e.video && n && ("IFRAME" === n || "VIDEO" === n)) {
                let i = t.image.height
                  ...
                  , s = t.image.marginTop;
                t.container.width > o && (o = t.container.width,
                i = o * e.image.height / e.image.width,
                r = 0,
                ...
                t) {
                    if (n.on("ready", ()=>{
                        if (e.options.videoPlayOnlyVisible) {
                            ...
                            e.onScroll = function() {
                                t.apply(e),
                                e.videoError || !e.options.videoLoop && (e.options.videoLoop || e.videoEnded) || (e.isVisible() ? n.play() : n.pause())
                            }
                        } else
                            n.play()
                    }
                    ...
                    e.defaultInitImgResult || n.getImageURL(t=>{
                        const n = e.$item.getAttribute("style");
                        n && e.$item.setAttribute("data-jarallax-original-styles", n),
                        e.css(e.$item, {
